...
class UsuarioModel extends ModeloBasePDO
{
    ...
    {
        $sql = "SELECT  correo_electronico ,  nombre ,  contrasena   FROM sessiones_login; ";
        $param = array();
    ...
    {
        $sql = "INSERT INTO  sessiones_login ( correo_electronico ,  nombre ,  contrasena ) 
    ...
    {
        $sql = "DELETE FROM  sessiones_login  WHERE  correo_electronico = :p_correo_electronico";
        $param = array();
        array_push($param, [':p_correo_electronico', $p_correo_electronico, PDO::PARAM_STR]);
