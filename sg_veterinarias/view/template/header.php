          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?php echo HTTP_BASE; ?>/web/sg/list" class="nav-link active">
                    <i class="fas fa-graduation-cap nav-icon"></i>
                    <p>Registro de Citas veterinaria</p>
                  </a>
                  <a href="<?php echo HTTP_BASE; ?>/web/sg/tratamiento" class="nav-link active">
                    <i class="fas fa-graduation-cap nav-icon"></i>
                    <p>Registro de tratamientos veterinaria</p>
                  </a>
                  </li>
              </ul>
            </li>
